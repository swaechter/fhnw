...
Freeway.h / Freeway.cpp
	Definiert den simulierten Autobahnabschnitt. Die Länge, die Anzahl Spuren, die Sektorlänge.
...
Units.h
	Definiert die verwendeten Standardeinheiten für Zeit (Sekunden, Minuten, Stunden), 
...
/////////////////////////////////////////////////////////////////////////////
Anpassungen/Ergänzungen im Unterricht:

Parking.h
	Definiert und implementiert einen Parkplatz für die Autos, welche die Simulation verlassen haben. Dadurch
	kann verhindert werden, dass ständig neue Autos erzeugt werden müssen. Bevor also ein 
	neues Auto erzeugt wird, sollte das Parking angefragt werden, ob es dort bereits ein 
	verfügbares Auto gibt. Das Parking wird als einfach-verknüpfte Liste von unique_ptr<Car>
...
Car.h
	...
	Zudem soll mit einer Klassenvariable die Farbe des nächsten Autos bestimmt werden.
...
Cars.h / Cars.cpp
	...
	Autos die gleiche Position, so müssen sie sich auf unterschiedlichen Spuren befinden.	
