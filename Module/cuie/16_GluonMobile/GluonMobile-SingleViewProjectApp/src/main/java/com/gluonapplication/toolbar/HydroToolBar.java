package com.gluonapplication.toolbar;
...
public class HydroToolBar extends ToolBar {
    ...
    public HydroToolBar(boolean showSearch) {
        initializeSelf(showSearch);
        initializeFont();
        initializeStyle();
        initializeParts();
        layoutParts();
    ...
    private void initializeSelf(boolean showSearch) {
    ...
    private void layoutParts() {
        ...
        if (showSearch) {
            ...
            getItems().addAll(saveButton, createButton, deleteButton, undoButton, redoButton, horizontalRegionSpacer, germanLanguageButton, englishLanguageButton);
        }
    }
